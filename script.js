...
while (k === '') {
  ...
  if (header === '3a3a') {
    ...
    console.log(
      'Packet length in hex :',
      packet_length,
      'in decimal :',
      parseInt(packet_length, 16)
    );
    ...
    if (prot_num === '10') {
      ...
      console.log(
        'Date :',
        parseInt(date.slice(4, 6), 16),
        '/',
        parseInt(date.slice(2, 4), 16),
        '/',
        parseInt(date.slice(0, 2), 16)
      );
      ...
      console.log(
        ...
        ':',
        parseInt(time.slice(2, 4), 16),
        ':',
        parseInt(time.slice(4, 6), 16)
      );
